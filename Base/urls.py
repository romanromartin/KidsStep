...
urlpatterns = i18n_patterns(
    ...
    path('anonimus', views.anonimus, name='anonimus'),
    ...
    path('footwear/<id_gender>/', views.type, name='type'),
    path('footwear/<id_gender>/<id_type>', views.footwear, name='footwear'),
    path('footwear/<id_gender>/<id_type>/<id>', views.footwear_detail, name='footwear_detail'),
